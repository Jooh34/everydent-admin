...
import { requestGetManufacturerList, requestGetProductInfoList,
  ...
  requestReturnStock, resetSuccessState } from '../redux/modules/product';

class ReturnStockForm extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isRequesting: true,
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Button theme='warning' style={btnStyle} onClick={this.handleSubmit}>반품</Button>
...
let mapDispatchToProps = (dispatch) => {
  return {
    ...
    requestReturnStock: () => dispatch(requestReturnStock()),
    resetSuccessState: () => dispatch(resetSuccessState()),
  };
};

ReturnStockForm = connect(mapStateToProps, mapDispatchToProps)(ReturnStockForm);
